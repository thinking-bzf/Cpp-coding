...
void ShowMenu();
void ListSort(LinkList<int> &);
void ShowList(LinkList<int> &);
void CreateList(LinkList<int> &);
void ReverseList(LinkList<int> &);
void MaxPlatform(LinkList<int> &);
void ExporttoFile(LinkList<int> &);
void PartitionList(LinkList<int> &);
void DeletebyValue(LinkList<int> &);
void SearchByValue(LinkList<int> &);
void ImportfromFile(LinkList<int> &);
void DeleteDuplicate(LinkList<int> &);
void DeletebyLocation(LinkList<int> &);
void InsertByLocation(LinkList<int> &);
void SearchByLocation(LinkList<int> &);
void input(int *x, int start = 0, int end = 999);
int main()
{
    int choice;
    LinkList<int> list(60);
    while (1)
    {
        ShowMenu();
...
void ListSort(LinkList<int> &list)
{
    int mode;
...
void CreateList(LinkList<int> &list)
{
...
void ShowList(LinkList<int> &list)
{
    if (!list.IsEmpty())
    {
        list.Show();
        ...
        cout << "The sequence LinkList is empty" << endl;
}
void SearchByLocation(LinkList<int> &list)
{
    // 寻找指定索引的值
    int index;
    if (!list.IsEmpty())
    {
        ...
        if (result != -1)
            cout << "The value of " << index << " in the sequence LinkList is " << result << endl;
    }
    else
        cout << "The list is empty." << endl;
}
void SearchByValue(LinkList<int> &list)
{
    // 寻找指定值的索引
    int value;
    if (!list.IsEmpty())
    {
        ...
        if (result != -1)
        {
            cout << "The first location of " << value << " in the sequence LinkList is " << result << "(start from 1)" << endl;
        }
        else
            cout << "The " << value << " is not in the sequence LinkList." << endl;
    }
    else
        cout << "The list is empty." << endl;
}
void InsertByLocation(LinkList<int> &list)
{
    int index, value;
    if (!list.IsEmpty())
    {
...
void DeletebyLocation(LinkList<int> &list)
{
    int index;
    if (!list.IsEmpty())
    {
        int result;
        cout << "Please input the index to delete:";
        input(&index, 0, list.Length());
...
void DeletebyValue(LinkList<int> &list)
{
    int value;
    if (!list.IsEmpty())
    {
...
void DeleteDuplicate(LinkList<int> &list)
{
    if (!list.IsEmpty())
    {
...
void ReverseList(LinkList<int> &list)
{
    if (!list.IsEmpty())
    {
...
void PartitionList(LinkList<int> &list)
{
    if (!list.IsEmpty())
    {
        int partiton;
...
void ImportfromFile(LinkList<int> &list)
{
    string Path;
...
void ExporttoFile(LinkList<int> &list)
{
    string Path;
    cout << "Please input the path of file:";
    while (!(cin >> Path))
...
void MaxPlatform(LinkList<int> &list)
{
    if (!list.IsEmpty())
    {
