...
int main()
{
	LinkedList<int> m_Link;

	cout << m_Link.isEmpty() << endl;
	m_Link.insertAfter(80);
	m_Link.insertRear(20);
	m_Link.insertFront(10);
	m_Link.insertRear(30);
	cout << m_Link.endOfList() << endl;
	m_Link.next();
	m_Link.display();
	m_Link.reset(2);
	m_Link.insertAfter(90);

	m_Link.insertFront(60);
	m_Link.display();

	m_Link.reset(3);
	cout << m_Link.data() << endl;

	m_Link.deleteCurrent();
	m_Link.deleteFront();
	cout << m_Link.isEmpty() << endl;
	...
	LinkedList<int> m_Link2(m_Link);
	m_Link2.display();
	m_Link2.reset(2);
	m_Link2.insertAfter(100);
	m_Link2.display();

	LinkedList<int> m_Link3;
	m_Link3.display();
	m_Link3 = m_Link;
	m_Link3.display();
